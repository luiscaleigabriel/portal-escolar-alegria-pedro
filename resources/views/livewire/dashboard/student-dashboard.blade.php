                            ...
                            <div>
                                ...
                                @if ($stat['change'])
                                    <div class="card-stat-change">
                                        <span
                                            class="{{ $stat['change_type'] === 'positive' ? 'change-positive' : 'change-negative' }}">
                                            <i
                                                class="fas fa-arrow-{{ $stat['change_type'] === 'positive' ? 'up' : 'down' }} me-1"></i>
                                            {{ $stat['change'] }}
                                        </span>
                                    </div>
                                @endif
        ...
        <div class="row g-4">
                                    ...
                                    <tbody>
                                        @foreach ($recentGrades as $grade)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge @if ($grade['value'] >= 14) bg-success @elseif($grade['value'] >= 10) bg-warning @else bg-danger @endif">
                                                        {{ $grade['value'] }}
                                                    </span>
                                                </td>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-none shadow-sm p-4 rounded-4 bg-white mb-4">
                        ...
                        <div class="mb-4">
                            @foreach ($pendingTasks as $task)
                                <div class="border-bottom pb-3 mb-3">
                                    ...
                                    <small class="text-muted d-block mb-1">{{ $task['subject'] }} •
                                        {{ $task['teacher'] }}</small>
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <a href="{{ route('student.tasks') }}" class="btn btn-sm btn-outline-primary">Ver
                                Tarefas</a>
                        </div>
                    @endif
                </div>
                ...
                <div class="card border-none shadow-sm p-4 rounded-4 bg-white">
                    ...
                    <a href="{{ route('common.blog.index') }}" class="btn btn-outline-primary w-100 mt-2">Aceder ao
                        Blog</a>
                </div>
            </div>
        </div>
