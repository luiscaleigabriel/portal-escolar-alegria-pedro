...
@section('title', 'Chat - Painel Administrativo')
                                    ...
                                    <div class="d-flex align-items-center p-3">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#"
                                                        onclick="downloadChat({{ $thread->id }})">
                                                ...
                                                <li>
                                                    <a class="dropdown-item text-danger" href="#"
                                                        onclick="return confirm('Arquivar esta conversa?')">
                    ...
                    <div class="card ip-card h-100">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button class="btn btn-sm btn-outline-success"
                                    onclick="downloadChat({{ $activeThread->id }})">
                        ...
                        <div class="card-footer">
                            <form id="sendMessageForm" data-thread-id="{{ $activeThread->id }}">
                                @csrf
                                <div class="input-group">
                                    <textarea class="form-control" id="messageInput" placeholder="Digite sua mensagem..." rows="2"></textarea>
                    ...
                    <div class="card ip-card h-100">
                        <div class="card-body d-flex align-items-center justify-content-center">
                            <div class="text-center">
                                ...
                                <p class="text-muted">Escolha uma conversa da lista ao lado para visualizar as mensagens.
                                </p>
            ...
            <div class="modal-content">
                <form action="{{ route('chat.store') }}" method="POST" id="newChatForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="chatSubjectInput" class="form-label">Assunto da Conversa</label>
                                            ...
                                            @foreach ($teachers as $teacher)
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input participant-checkbox" type="checkbox"
                                                        ...
                                                        id="teacher_{{ $teacher->id }}" data-type="teacher">
                                                    <label class="form-check-label" for="teacher_{{ $teacher->id }}">
                                                        {{ $teacher->user->name }}
                                                        <small
                                                            class="text-muted d-block">{{ $teacher->user->email }}</small>
                                                    </label>
                                                </div>
                                            @endforeach
                                        </div>
                                            ...
                                            @foreach ($students as $student)
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input participant-checkbox" type="checkbox"
                                                        ...
                                                        id="student_{{ $student->id }}" data-type="student">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-check mb-2">
                                                            <input class="form-check-input participant-checkbox"
                                                                type="checkbox" value="{{ $guardian->user->id }}"
                                                                id="guardian_{{ $guardian->id }}" data-type="guardian">
                                                            <label class="form-check-label"
                                                                for="guardian_{{ $guardian->id }}">
                                                                {{ $guardian->user->name }}
                                                                <small class="text-muted d-block">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                participantCheckboxes.forEach(checkbox => {
                    checkbox.addEventListener('change', function() {
                        ...
                        const userName = this.closest('label').querySelector(
                            'strong, .form-check-label').textContent.trim();
                ...
                window.removeParticipant = function(userId) {
                    selectedParticipants = selectedParticipants.filter(p => p.id !== userId);
                    document.querySelector(`.participant-checkbox[value="${userId}"]`).checked = false;
                    updateSelectedParticipants();
                    validateChatForm();
                };
                ...
                function validateChatForm() {
                    ...
                    const isValid = selectedParticipants.length >= 2;
