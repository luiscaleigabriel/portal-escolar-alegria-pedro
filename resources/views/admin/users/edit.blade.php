                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" name="status" required>
                                            ...
                                            <option value="approved" {{ old('status', $user->status) == 'approved' ? 'selected' : '' }}>Aprovado</option>
                                            <option value="rejected" {{ old('status', $user->status) == 'rejected' ? 'selected' : '' }}>Rejeitado</option>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="turma_id">
                                            ...
                                            <option value="{{ $turma->id }}" {{ old('turma_id', $profile->turma_id ?? '') == $turma->id ? 'selected' : '' }}>
                                                {{ $turma->name }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <select class="form-select" name="student_ids[]" multiple style="height: 200px;">
                                            @foreach($students as $student)
                                            <option value="{{ $student->id }}"
                                                {{ old('student_ids', $profile->students->pluck('id')->toArray() ?? []) ?
                                                   (in_array($student->id, old('student_ids', $profile->students->pluck('id')->toArray() ?? [])) ? 'selected' : '') : '' }}>
                                                {{ $student->user->name }}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        userForm.addEventListener('submit', function(e) {
            if (statusSelect.value === 'rejected' || statusSelect.value === 'suspended') {
                if (!confirm('Alterar o status para "' + statusSelect.options[statusSelect.selectedIndex].text +
