                    ...
                    <div class="row">
                        <div class="col-md-3 text-center mb-4">
                            <div class="avatar-xl mx-auto mb-3">
                                ...
                                @endphp
                                <div class="avatar-title bg-{{ $roleColors[$roleName] ?? 'secondary' }}-subtle
                    ...
                    @if($user->hasRole('student') && $profile)
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="mb-0">
                                    <a href="{{ route('turmas.show', $profile->turma) }}" class="text-decoration-none">
                                        {{ $profile->turma->name }}
                                    </a>
                                </p>
                            </div>
