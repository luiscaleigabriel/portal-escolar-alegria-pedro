                                ...
                                <div class="avatar-xl mx-auto mb-3">
                                    <div
                                        class="avatar-title bg-{{ [
                                            ...
                                            'admin' => 'danger',
                                            'director' => 'success',
                                        ][$user->roles->first()->name] ?? 'secondary' }}-subtle
                                text-{{ [
                                    'student' => 'primary',
                                    'teacher' => 'warning',
                                    'guardian' => 'info',
                                    'admin' => 'danger',
                                    'director' => 'success',
                                ][$user->roles->first()->name] ?? 'secondary' }} rounded-circle">
                                        <i
                                            class="lni {{ [
                                                ...
                                                'admin' => 'lni-cog',
                                                'director' => 'lni-star',
                                            ][$user->roles->first()->name] ?? 'lni-user' }} display-4"></i>
                                    </div>
                                </div>
                                <div>
                            ...
                            <div class="col-md-9">
                                <div class="row g-3">
                                    ...
                                    @if ($user->emergency_contact)
                                        <div class="col-md-6">
                                            <label class="form-label text-muted small mb-1">Contato de Emergência</label>
                                    ...
                                    @if ($user->approved_at)
                                        <div class="col-md-6">
                                            <label class="form-label text-muted small mb-1">Data de Aprovação</label>
                                            <p class="mb-0">
                                    ...
                                    @if ($user->status === 'rejected' && $user->rejection_reason)
                                        <div class="col-12">
                                            <label class="form-label text-muted small mb-1">Motivo da Rejeição</label>
                            ...
                            <h6 class="mb-0">
                                <i
                                    class="lni {{ [
                                        ...
                                        'teacher' => 'lni-users',
                                        'guardian' => 'lni-user',
                                    ][$user->roles->first()->name] ?? 'lni-user' }} me-2"></i>
                                Informações de {{ ucfirst($user->roles->first()->name) }}
                            </h6>
                        </div>
                        <div class="card-body">
                            @if ($user->hasRole('student') && $profile)
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-0">{{ $profile->registration_number ?? 'Não atribuído' }}</p>
                                    </div>
                                    @if ($profile->turma)
                                        <div class="col-md-6">
                            ...
                            @elseif($user->hasRole('teacher') && $profile)
                                <div class="alert alert-info">
                                    ...
                                    Perfil de professor criado. As turmas e disciplinas serão atribuídas pela administração.
                                </div>
                            @elseif($user->hasRole('guardian') && $profile)
                                @if ($profile->students->isNotEmpty())
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label text-muted small mb-1">Alunos Vinculados</label>
                                ...
                                @else
                                    <div class="alert alert-warning">
                                        <i class="lni lni-warning me-2"></i>
                                        Nenhum aluno vinculado. Contate a administração para fazer os vínculos necessários.
                                    </div>
                                @endif
                            @endif
                        </div>
